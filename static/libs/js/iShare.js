...
(function (root, factory) {
    ...
    iShare.prototype = (function(){
        // 接口模板
        var _templates = {
                iShare_qq          : 'http://connect.qq.com/widget/shareqq/index.html?url={{URL}}&title={{TITLE}}&desc={{DESCRIPTION}}&summary={{DESCRIPTION}}&pics={{IMAGE}}',
                ...
                iShare_weibo       : 'http://service.weibo.com/share/share.php?url={{URL}}&title={{TITLE}}&desc={{DESCRIPTION}}&summary={{DESCRIPTION}}&pic={{IMAGE}}',
                iShare_wechat			 : '',
